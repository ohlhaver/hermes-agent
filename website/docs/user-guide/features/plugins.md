...
| [`tool_bridge_error`](/user-guide/features/hooks#tool_bridge_error) | Deferred `tool_call` rejects invalid nested JSON before the underlying tool runs; shape metadata only |
